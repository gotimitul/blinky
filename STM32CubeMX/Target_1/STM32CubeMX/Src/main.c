...
int main(void) {
  ...
  osThreadId_t tid_app = NULL; // Declare thread ID for the application main

  // Create thread attributes for the main application thread
  const osThreadAttr_t app_main_config = {
      .name = "app_main",
